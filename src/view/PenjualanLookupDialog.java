 ...
 * @author Fuady
 */
public class PenjualanLookupDialog extends javax.swing.JDialog {

    private Penjualan penjualan;
    private final List<Penjualan> penjualanList;

    public PenjualanLookupDialog() {
        ...
        penjualanList = Main.getTransaksiServices().getPenjualans();
        tblSales.setModel(new SalesTableModel(penjualanList));
    }
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addComponent(txtSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 472, Short.MAX_VALUE))
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (penjualan != null) {
            ...
            JOptionPane.showMessageDialog(this, "Pilih satu penjualan!",
    ...
    private class SalesSelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            if (tblSales.getSelectedRow() >= 0) {
                penjualan = penjualanList.get(tblSales.getSelectedRow());
            }
        }
    ...
    private class SalesTableModel extends AbstractTableModel {
        ...
        private final List<Penjualan> penjualans;

        public SalesTableModel(List<Penjualan> penjualans) {
